...
(custom-theme-set-faces! 'doom-plain
  ...
  ;; '(mode-line :background "#e7e4d4")
  ;; '(mode-line-inactive :background "#f0eee4" :foreground "#d5cfb3")
  ;; '(match :background "#d5cfb3")
  ;; '(swiper-line-face :background "#d5cfb3")
  ;; '(lazy-highlight :background "#f0eee4")
  ...
  '(popup-face :background "#f0eee4")
  '(popup-tip-face :background "#f0eee4")
  '(popup-menu-face :background "#f0eee4")
  ...
  '(org-block-begin-line :inherit 'org-special-keyword)
  '(org-block :foreground "#444" :background "#f0eee4" :extend t)
  '(org-block-end-line :inherit 'org-special-keyword)
