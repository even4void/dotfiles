...
(custom-theme-set-faces! 'doom-plain
  ...
  '(org-quote :background "#e7e7e7" :slant italic :extend t)
  '(org-block-begin-line :foreground "#7e7f81" :background "#e7e7e7" :extend t)
  '(org-block :foreground "#444" :background "#e7e7e7" :extend t)
  '(org-block-end-line :foreground "#7e7f81" :background "#e7e7e7" :extend t)
