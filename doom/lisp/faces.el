...
(custom-theme-set-faces! 'doom-plain
  ...
  '(hl-line :background "#fffff8")
  '(nav-flash-face :foreground nil :background "#f0eee4" :extend t)
  '(header-line :background "#f0eee4")
  '(highlight :background "#f0eee4")
  '(popup-tip-face :background "#f0eee4")
  ...
  '(org-block-begin-line :foreground "#7e7f81" :background "#f0eee4" :extend t)
  '(org-block :foreground "#444" :background "#f0eee4" :extend t)
  '(org-block-end-line :foreground "#7e7f81" :background "#f0eee4" :extend t)
  ...
  '(org-journal-calendar-entry-face :background "#9099ab" :foreground "#fffff8")
  '(org-scheduled-previously :foreground "#c5c8c6")
  '(org-scheduled-today :foreground "#7e7f81")
  '(org-date-selected :foreground "#bf616a")
  ...
  '(markdown-language-keyword-face :foreground "#7e7f81" :background "#f0eee4" :extend t)
  '(markdown-code-face :background "#f0eee4" :extend t)
  '(markdown-blockquote-face :slant italic)
  '(markdown-footnote-marker-face :foreground "#9099ab" :weight bold :underline t)
  '(mu4e-highlight-face :foreground "#444" :weight bold)
  '(message-cited-text-1 :foreground "#416978")
  '(magit-header-line :background nil)
  '(lui-irc-colors-fg-0-face :foreground "#20111a")
  '(lui-irc-colors-fg-1-face :foreground "#bd100d")
  '(lui-irc-colors-fg-2-face :foreground "#858062")
  '(lui-irc-colors-fg-3-face :foreground "#e9a448")
  '(lui-irc-colors-fg-4-face :foreground "#416978")
  '(lui-irc-colors-fg-5-face :foreground "#96522b")
  '(lui-irc-colors-fg-6-face :foreground "#98999c")
  '(lui-irc-colors-fg-7-face :foreground "#958b83")
  '(lui-irc-colors-fg-8-face :foreground "#20111a")
  '(lui-irc-colors-fg-9-face :foreground "#bd100d")
  '(lui-irc-colors-fg-10-face :foreground "#858062")
  '(lui-irc-colors-fg-11-face :foreground "#e9a448")
  '(lui-irc-colors-fg-12-face :foreground "#416978")
  '(lui-irc-colors-fg-13-face :foreground "#96522b")
  '(lui-irc-colors-fg-14-face :foreground "#98999c")
  '(lui-irc-colors-fg-15-face :foreground "#958b83")
  '(flycheck-error :foreground "#fffff8" :background "#bf616a" :underline nil)
